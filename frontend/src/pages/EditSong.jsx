...
const EditSong = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((error) => {
        setLoading(false);
        enqueueSnackbar("Error: Song info failed to retrieve, please check console!", {
          variant: "error",
        });
        console.error(error);
      });
  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <div className='my-4'>
          <label className='text-xl mr-4 text-gray-700'> Favorite </label>
          <input
            type='checkbox'
            checked={favorited}
        ...
        <button className='p-2 bg-sky-950 m-8 text-white' onClick={handleEditSong}>
          Save
        </button>
      </div>
    </div>
