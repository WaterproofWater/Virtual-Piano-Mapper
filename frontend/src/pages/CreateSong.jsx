  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex items-center justify-center mb-5'>
        <button
          className='flex items-center gap-2 bg-sky-900 text-white px-4 py-2 rounded-full hover:bg-sky-700 transition'
          onClick={handleAddUsingURL}
        >
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <button
          className='p-2 bg-blue-600 m-8 text-white rounded-full hover:bg-blue-700 transition'
